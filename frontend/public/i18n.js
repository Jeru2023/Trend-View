  ...
  const registry = {
    ...
    marketIntelligence: {
      ...
      en: {
        ...
        colName: "Name",
        colIndustry: "Industry",
        colAnnDate: "Announcement",
        colEndDate: "Reporting Period",
        colRevenue: "Revenue",
        colOperateProfit: "Operating Profit",
        colNetIncome: "Net Profit",
        colDilutedEps: "Diluted EPS",
        colDilutedRoe: "Diluted ROE",
        colYoyNetProfit: "YoY Net Profit",
        colPerfSummary: "Summary",
        paginationPrev: "Previous",
        paginationNext: "Next",
        paginationInfo: "Page {current} of {totalPages} · {total} results",
      ...
      zh: {
        ...
        colEndDate: "报告期",
        colRevenue: "营业收入",
        colOperateProfit: "营业利润",
        colNetIncome: "净利润",
        colDilutedEps: "摊薄每股收益",
        colDilutedRoe: "摊薄ROE",
        colYoyNetProfit: "净利润同比",
        colPerfSummary: "摘要",
        paginationPrev: "上一页",
        paginationNext: "下一页",
        paginationInfo: "第 {current} / {totalPages} 页 · 共 {total} 条",
    ...
    performanceForecast: {
      en: {
        ...
        pageSubtitle: "Latest earnings forecast disclosures from Tushare.",
        filterKeyword: "Keyword",
        filterStartDate: "Start Date",
        filterEndDate: "End Date",
        apply: "Apply",
        ...
        colAnnDate: "Announcement",
        colEndDate: "Reporting Period",
        colForecastType: "Type",
        colForecastPct: "Change (%)",
        colForecastProfit: "Net Profit (Min/Max)",
        colLastParentNet: "Last Parent Net",
        colFirstAnnDate: "First Announcement",
        colSummary: "Summary",
        paginationPrev: "Previous",
        paginationNext: "Next",
        paginationInfo: "Page {current} of {totalPages} · {total} results",
      ...
      zh: {
        title: "趋势视图 - 业绩预告",
        pageTitle: "业绩预告",
        pageSubtitle: "展示来自 Tushare 的最新业绩预告数据。",
        filterKeyword: "关键词",
        filterStartDate: "起始日期",
        filterEndDate: "结束日期",
        apply: "应用",
        ...
        colEndDate: "报告期",
        colForecastType: "类型",
        colForecastPct: "涨跌幅区间",
        colForecastProfit: "净利润区间",
        colLastParentNet: "上年净利润",
        colFirstAnnDate: "首次公告",
        colSummary: "摘要",
        paginationPrev: "上一页",
        paginationNext: "下一页",
        paginationInfo: "第 {current} / {totalPages} 页 · 共 {total} 条",
