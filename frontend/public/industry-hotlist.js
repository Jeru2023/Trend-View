...
const elements = {
  refreshButton: document.getElementById("sector-insight-refresh"),
  status: document.getElementById("sector-insight-status"),
  generatedAt: document.getElementById("sector-insight-generated-at"),
  symbols: document.getElementById("sector-insight-symbols"),
  industryGrid: document.getElementById("sector-insight-industry-grid"),
...
function renderIndustryCards(items) {
  const container = elements.industryGrid;
  if (!container) return;
  const dict = getDict();
